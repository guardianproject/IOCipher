...
public class RandomAccessFile implements DataInput, DataOutput, Closeable {
     ...
     * @param mode the file access <a href="#accessmode">mode</a>, either
     ...
     * @throws IllegalArgumentException if {@code mode} is not {@code "r"},
     *             {@code "rw"}, {@code "rws"} or {@code "rwd"}.
     */
     ...
     * Closes this file.
     * 
     * @throws IOException if an error occurs while closing this file.
     */
     ...
     * <p>
     * The file channel's {@link IOCipherFileChannel#position() position} is the
     * same as this file's file pointer offset (see {@link #getFilePointer()}).
     ...
     * @throws IOException if an error occurs while getting the file descriptor
     *             of this file.
     */
     ...
     * @throws IOException if an error occurs while getting the file pointer of
     *             this file.
     */
     ...
     * @throws IOException if this file is closed or some other I/O error
     *             occurs.
     */
    ...
    /**
     * Reads at most {@code byteCount} bytes from the current position in this
     * file and stores them in the byte array {@code buffer} starting at
     * {@code byteOffset}. Blocks until at least one byte has been read, the end
     * of the file is detected, or an exception is thrown.
     * 
     * @return the number of bytes actually read or -1 if the end of the stream
     *         has been reached.
     * @throws IndexOutOfBoundsException if {@code byteOffset < 0} or
     *             {@code byteCount < 0}, or if {@code byteOffset + byteCount}
     ...
     * file. Blocks until two bytes have been read, the end of the file is
     ...
     * Blocks until eight bytes have been read, the end of the file is reached
     ...
     * Blocks until four bytes have been read, the end of the file is reached or
    ...
    /**
     * Reads {@code byteCount} bytes from this stream and stores them in the
     * byte array {@code dst} starting at {@code offset}. If {@code byteCount}
     * is zero, then this method returns without reading any bytes. Otherwise,
     * this method blocks until {@code byteCount} bytes have been read. If
     * insufficient bytes are available, {@code EOFException} is thrown. If an
     * I/O error occurs, {@code IOException} is thrown. When an exception is
     ...
     * @throws EOFException if the end of the source stream is reached before
     ...
     * Blocks until two bytes have been read, the end of the file is reached or
     * an exception is thrown.
     * 
     ...
     * this file and returns it as an integer. Blocks until two bytes have been
     * read, the end of the file is reached or an exception is thrown.
     * 
     ...
     * @throws EOFException if the end of this file is detected.
     * @throws IOException if this file is closed or another I/O error occurs.
     * @throws UTFDataFormatException if the bytes read cannot be decoded into a
     *             character string.
     * @see #writeUTF(String)
     */
    public final String readUTF() throws IOException {
        ...
        /*
         * TODO implement this #566 int utfSize = readUnsignedShort(); if
         * (utfSize == 0) { return ""; } byte[] buf = new byte[utfSize]; if
         * (read(buf, 0, buf.length) != buf.length) { throw new EOFException();
     ...
     * @throws IOException if this file is closed, {@code pos < 0} or another
     *             I/O error occurs.
     */
     ...
     * @throws IllegalArgumentException if {@code newLength < 0}.
     * @throws IOException if this file is closed or another I/O error occurs.
     */
     ...
     * file, starting at the current file pointer and using {@code byteOffset}
     * as the first position within {@code buffer} to get bytes.
     * 
     * @throws IndexOutOfBoundsException if {@code byteCount < 0},
     *             {@code byteOffset < 0} or {@code byteCount +
     ...
     * current file pointer. Only the two least significant bytes of the integer
     * {@code val} are written, with the high byte first.
     * 
    ...
    /**
     * Writes big-endian 16-bit characters from {@code str} to this file,
     * starting at the current file pointer.
     * 
     ...
     * file pointer. The bytes are those returned by
     ...
     * file pointer. The bytes are those returned by
     * {@link Float#floatToIntBits(float)}, meaning a canonical NaN is used.
     * 
     ...
     * file pointer. Only the two least significant bytes of the integer
     * {@code val} are written.
     * 
     ...
     * 
     * @param str the string to write in {@link DataInput modified UTF-8}
     *            format.
     * @throws IOException if an I/O error occurs while writing to this file.
     * @throws UTFDataFormatException if the encoded string is longer than 65535
     *             bytes.
     * @see #readUTF()
     */
    public final void writeUTF(String str) throws IOException {
        throw new UnsupportedOperationException("not yet implemented");
        /*
         * TODO implement #566 write(ModifiedUtf8.encode(str));
         */
    }
}
